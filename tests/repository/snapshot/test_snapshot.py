...
class SnapshotTests:
    ...
    def setup_method(self, aggregate_root_cls_mock, snapshot_backend_mock, importer_mock):
        ...
        self.backend = snapshot_backend_mock(return_value=self.snapshot_data_mock)
    ...
    def test_load(self):
        ...
        test_hash = snapshot.hash_function(aggregate_root.get_representation())

        self.backend().load.assert_called_once_with(test_id)
        self.deserializer.assert_called_once_with(self.snapshot_data_mock, test_hash)
