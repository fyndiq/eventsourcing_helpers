...
class ESEntityBuilderTests:
    ...
    def test_get_events_stop_with_max_offset(self):
        events_max_offset1 = list(self.factory._get_events(id="123", max_offset=1))
        events_max_offset2 = list(self.factory._get_events(id="123", max_offset=2))
    ...
    def test_rebuild_returns_the_entity_in_the_right_state_when_max_offset_is_given(self):
